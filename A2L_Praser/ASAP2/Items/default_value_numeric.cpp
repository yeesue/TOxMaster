...
void DEFAULT_VALUE_NUMERIC::parseFixPar(QList<TokenTyp> *typePar)
{
...
QMap<std::string, std::string> DEFAULT_VALUE_NUMERIC::getParameters()
{
...
char* DEFAULT_VALUE_NUMERIC::getPar(std::string str)
{
