...
A2L_PARSER_INTERFACE::A2L_PARSER_INTERFACE(QObject *parent) :
    QObject(parent)
{
    this->appPath = QApplication::applicationDirPath();
    this->a2lParserDllPath = appPath + "/driver/A2L_Parser.dll";
...
void A2L_PARSER_INTERFACE::init_A2LParser()
{
    ...
    if (dllLib.load())
    {
        qDebug()<<"load A2LParser dll init ok!";
        Init init = (Init)dllLib.resolve("Init");
        if (init)
        {
            qDebug()<<"resolve A2LParser dll init ok!";
            init();

        }
        else
        {
            qDebug()<<"resolve A2LParser dll init error.";
        }
    }
    else
    {
        QMessageBox::information(NULL, "NO", "A2LParser Dll is not loaded!");
    }
}
...
void A2L_PARSER_INTERFACE::show_A2LParserWin()
{
    QLibrary dllLib(a2lParserDllPath);
    if (dllLib.load())
    {
        qDebug()<<"load A2LParser dll show ok!";
        Show show = (Show)dllLib.resolve("Show");
        if (show)
        {
            qDebug()<<"resolve A2LParser dll show ok!";
            show();
        }
        else
        {
...
typedef bool (*LoadParser)(QString, QStringList*);

bool A2L_PARSER_INTERFACE::loadFile_A2LParser(QString fullFileName, QStringList &infoList)
{
    ...
    if (dllLib.load())
    {
        qDebug()<<"load loadParser ok!";
        LoadParser loadParser = (LoadParser)dllLib.resolve("parserA2LFileToTreeModel");
        if (loadParser)
        {
            qDebug()<<"resolve loadParser ok!";
            bool status = loadParser(fullFileName, &infoList);
            if(status)
            {
        ...
        {
            qDebug()<<"resolve loadParser error.";
            return false;
        }
    }
    else
...
bool A2L_PARSER_INTERFACE::addHexToA2LFile(QString fullFileName, QString fullHexName, QStringList &infoList)
{
...
QStringList A2L_PARSER_INTERFACE::getMeasNameList(QString fullFileName)
{
...
QStringList A2L_PARSER_INTERFACE::getCharNameList(QString fullFileName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetMeasNodeInfoByName(QString fullFileName, QString reqMeasName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetCharNodeInfoByName(QString fullFileName, QString reqCharName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetCompMNodeInfoByName(QString fullFileName, QString reqCompMName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetRecordLayoutNodeInfoByName(QString fullFileName, QString reqRecordLayoutName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetAxisPtsNodeInfoByName(QString fullFileName, QString reqAxisPtsName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetCompVtabNodeInfoByName(QString fullFileName, QString reqCompVtabName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetDaqNodeInfoByName(QString fullFileName, QString reqDaqName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetDaqMemConsumpNodeInfoByName(QString fullFileName, QString reqDaqMemConsumpName)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetXcpOnCanNodeInfoByNameAndIndex(QString fullFileName, QString reqXcpOnCanName, int index)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetEventNodeInfoByNameAndIndex(QString fullFileName, QString reqEventName, int index)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetEventCanIdNodeInfoByNameAndIndex(QString fullFileName, QString reqEventCanIdName, int index)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetDaqNodeInfoInXcpOnCanByName(QString fullFileName, QString reqDaqName, int indexXcpOnCan)
{
    if (fullFileName.isEmpty() || reqDaqName.isEmpty())
        return NULL;
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetDaqMemConsumpNodeInfoInXcpOnCanByName(QString fullFileName, QString reqDaqMemConsumpName, int indexXcpOnCan)
{
    if (fullFileName.isEmpty() || reqDaqMemConsumpName.isEmpty())
        return NULL;
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetEventNodeInfoInXcpOnCanByNameAndIndex(QString fullFileName, QString reqEventName, int index, int indexXcpOnCan)
{
    if (fullFileName.isEmpty() || reqEventName.isEmpty())
        return NULL;
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetCanFdNodeInfoInXcpOnCanByName(QString fullFileName, QString reqCanFdName, int indexXcpOnCan)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetMemorySegmentNodeInfoByNameAndIndex(QString fullFileName, QString reqMemorySegmentName, int index)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetPageNodeInfoInMemorySegmentByNameAndIndex(QString fullFileName, QString reqPageName, int index, int indexMemorySegment)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetDaqListNodeInfoByNameAndIndex(QString fullFileName, QString reqDaqListName, int index)
{
...
QMap<QString, QString> *A2L_PARSER_INTERFACE::GetDaqListCanIdNodeInfoByNameAndIndex(QString fullFileName, QString reqDaqListCanIdName, int index)
{
...
QMap<QString, QStringList> *A2L_PARSER_INTERFACE::GetCharHexValueByName(QString fullFileName, QString fullHexName, QString reqCharName, bool *ok)
{
