#ifndef A2L_PRASER_INTERFACE_H
#define A2L_PRASER_INTERFACE_H

#include <QObject>

class A2L_PRASER_INTERFACE : public QObject
{
    Q_OBJECT
public:
    A2L_PRASER_INTERFACE(QObject* parent = 0);

    void init_A2LPraser();
    void show_A2LPraserWin();

    bool loadFile_A2LPraser(QString fullFileName, QStringList &infoList);
...
private:
    QString appPath;
    QString a2lPraserDllPath;
};

#endif // A2L_PRASER_INTERFACE_H
