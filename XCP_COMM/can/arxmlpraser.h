#ifndef ARXMLPRASER_H
#define ARXMLPRASER_H
...
class ArxmlPraser : public QObject
{
    Q_OBJECT
public:
    explicit ArxmlPraser(QObject *parent = nullptr, QString filePath = "");
    ~ArxmlPraser();

    bool getPraserOk() const;
...
private:
    bool praserArxml(QString filePath);
