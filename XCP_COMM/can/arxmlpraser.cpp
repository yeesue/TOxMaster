...
ArxmlPraser::ArxmlPraser(QObject *parent, QString filePath) :
    QObject(parent),
    arxmlFilePath(filePath)
{
    ...
    praserOk = praserArxml(arxmlFilePath);

    arxmlPackagesToClusters(this->arXmlPackages);
}

ArxmlPraser::~ArxmlPraser()
{
    if(arXmlPackages)
    {
...
QStringList ArxmlPraser::getGenDbcFileList() const
{
    return genDbcFileList;
}

QList<dbc_Cluster *> ArxmlPraser::getCanClusters() const
{
    return canClusters;
}

QString ArxmlPraser::canClusterToDBC(dbc_Cluster *dbcCluster)
{
    if(dbcCluster == NULL)
        return "";
...
QString ArxmlPraser::getArxmlName() const
{
    return arxmlName;
}

AR_XML_PACKAGES *ArxmlPraser::getArXmlPackages() const
{
    return arXmlPackages;
}


bool ArxmlPraser::getPraserOk() const
{
    return praserOk;
}

bool ArxmlPraser::praserArxml(QString filePath)
{
    qDebug()<<"===========Start of Arxml Prasering==========";
    ...
    qDebug()<<"==========Begin to praser the file============";
    ...
    qDebug()<<"===============CAN COMMUNICATION CONTROLLER praser===============";
    ...
    qDebug()<<"===============CAN COMMUNICATION CONNECTOR praser===============";
    ...
    /*--------------SYSTEM-SIGNAL Praser---------------*/
    qDebug()<<"===============SYSTEM-SIGNAL praser===============";
    ...
    /*-------------PDU CONTAINER Praser------------*/
    qDebug()<<"===============PDU CONTAINER praser===============";
    ...
    qDebug()<<"===========End of Arxml Prasering==========";

    return true;
}

void ArxmlPraser::arxmlPackagesToClusters(AR_XML_PACKAGES *arXmlPackages)
{
...
void ArxmlPraser::arCanClusterToCluster(AR_CAN_CLUSTER_SIM *arCanCluster, dbc_Cluster *dbcCluster)
{
...
AR_SIGNAL_TRIG *ArxmlPraser::findSignalTrigPtrByName(QList<AR_SIGNAL_TRIG *> sigTrigList, QString name)
{
...
AR_PDU_TRIG *ArxmlPraser::findPDUTrigPtrByName(QList<AR_PDU_TRIG *> pduTrigList, QString name)
{
...
AR_PDU_CONTAINER *ArxmlPraser::findPDUContainerPtrByName(QList<AR_PDU_CONTAINER*> pduContainerList, QString name)
{
...
AR_PDU *ArxmlPraser::findPDUPtrByName(QList<AR_PDU *> pduList, QString name)
{
    if (pduList.isEmpty())
        return NULL;
    AR_PDU *pdu;
...
AR_FRAME *ArxmlPraser::findFramePtrByName(QList<AR_FRAME*> frameList, QString name)
{
...
AR_SIGNAL *ArxmlPraser::findSignalPtrByName(QList<AR_SIGNAL *> signalList, QString name)
{
...
AR_SYS_SIGNAL *ArxmlPraser::findSysSignalPtrByName(QList<AR_SYS_SIGNAL *> sysSignalList, QString name)
{
...
AR_BASETYPE *ArxmlPraser::findBaseTypePtrByName(QList<AR_BASETYPE *> baseTypeList, QString name)
{
...
AR_COMPU_METHOD *ArxmlPraser::findCompuMethodPtrByName(QList<AR_COMPU_METHOD *> compuMethodList, QString name)
{
...
AR_CAN_COMM_CONTROLLER *ArxmlPraser::findCanCommControllerByName(QList<AR_CAN_COMM_CONTROLLER *> canCommControllerList, QString name)
{
...
AR_CAN_COMM_CONNECTOR *ArxmlPraser::findCanCommConnectorByName(QList<AR_CAN_COMM_CONNECTOR *> canCommConnectorList, QString name)
{
...
AR_FRAME *ArxmlPraser::findFrameByRefPDU(QList<AR_FRAME*> frameList, AR_PDU *pdu)
{
...
QString ArxmlPraser::textOfFirstElementByTagName(QDomElement elem, QString tagName)
{
...
QString ArxmlPraser::textOfFirstElementByTagNames(QDomElement elem, QString tagName1, QString tagName2)
{
...
QString ArxmlPraser::textOfIndexElementByTagName(QDomElement elem, QString tagName, int index)
{
    QDomNodeList nodeList = elem.elementsByTagName(tagName);
...
QStringList ArxmlPraser::textListOfElementsByTagName(QDomElement elem, QString tagName_Multi)
{
...
QStringList ArxmlPraser::textListOfElementsByTagNames(QDomElement elem, QString tagName_Single, QString tagName_Multi)
{
...
void ArxmlPraser::writeTextLine(QString textLine)
{
...
void ArxmlPraser::writeText_dbc_Prefix()
{
...
void ArxmlPraser::writeText_dbc_FrameAndSignal(dbc_Cluster *dbcCluster)
{
...
void ArxmlPraser::writeText_dbc_Attrs(dbc_Cluster *dbcCluster)
{
    QStringList strList;
    strList.clear();
...
void ArxmlPraser::writeText_dbc_Frame_Attrs(dbc_Cluster *dbcCluster)
{
    int frameCount = dbcCluster->m_frames.count();
    for (int i = 0; i < frameCount; i++)
    {
...
void ArxmlPraser::writeText_dbc_Signal_Attrs(dbc_Cluster *dbcCluster)
{
    int frameCount = dbcCluster->m_frames.count();
    for (int i = 0; i < frameCount; i++)
    {
...
void ArxmlPraser::writeText_dbc_Signal_ValTables(dbc_Cluster *dbcCluster)
{
    int frameCount = dbcCluster->m_frames.count();
    for (int i = 0; i < frameCount; i++)
    {
...
QString ArxmlPraser::addQuotes(QString text)
{
    return ("\"" + text + "\"");
}

QString ArxmlPraser::textLineFrame_BO_(dbc_frame *frame)
{
    if (!frame)
        return "";
...
QString ArxmlPraser::textLineSignal_SG_(dbc_signal *signal)
{
    if (!signal)
        return "";
    QString valTypeStr = "";
...
QString ArxmlPraser::attrTextLine_BA_DEF_(QString Category, QString attrName, QString type, QStringList valueList)
{
    QString valueStr = "";
...
QString ArxmlPraser::attrTextLine_BA_DEF_DEF_(QString attrName, QString initValue)
{
...
QString ArxmlPraser::attrTextLine_BA_(QString attrName, QString Category, QStringList infoList, QString initValue)
{
    QString infoStr = "";
...
QString ArxmlPraser::valTextLine_VAL_(QStringList infoList, QList<ValTable *> valTableList)
{
    QString infoStr = "";
    for (int i = 0; i < infoList.count(); i++)
    {
...
QHash<QString, QString> ArxmlPraser::getClusterDbcHash() const
{
