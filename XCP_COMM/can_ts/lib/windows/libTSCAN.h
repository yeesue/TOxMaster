...
#else
// MinGW: remove __stdcall to avoid symbol name mismatch
#ifdef __GNUC__
...
typedef struct _TLIBFlexray_controller_config {
	...
	u8 wake_up_idx;                // Wake up channe: 0:ChannelAï¿½ï¿½ 1:ChannelB
