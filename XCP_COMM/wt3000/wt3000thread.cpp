...
bool WT3000Thread::connectDevice()
{
...
bool WT3000Thread::disconnectDevice()
{
    stopFlg=true;
    wait(1000);
    //Sets local mode.
...
void WT3000Thread::setIPAddress(QString address)
{
    IPAddress=address;
}

void WT3000Thread::setFunInfo(FunStruct *value, int index)
{
    fun = value;
    funIndex = index;
}

void WT3000Thread::run()
{
    char buff[65535];
    int length;
    uint currentTime;
