...
#include "ui_wt3000setdlg.h"
#include <QFile>
#include <QFileInfo>
#include <QDebug>

WT3000SetDlg::WT3000SetDlg(QWidget *parent, QString work_name, QString fun_name, QString intf_name, QString set_file_path) :
    QDialog(parent),
    workName(work_name), funName(fun_name),
    intfName(intf_name), setFilePath(set_file_path),
    ui(new Ui::WT3000SetDlg)
{
    ui->setupUi(this);
    setWindowTitle("wt3000 setting(" + workName.toLower() + "/" + funName.toLower() + ")");
...
WT3000SetDlg::~WT3000SetDlg()
{
    delete ui;
}

void WT3000SetDlg::accept()
{
    writeSetting();
    QDialog::accept();
}

void WT3000SetDlg::writeSetting()
{
...
QString WT3000SetDlg::getSetFilePath() const
{
    return setFilePath;
}
