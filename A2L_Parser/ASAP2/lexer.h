...
enum TokenTyp
{
    ...
    PrgType, MemoryType, MemAttribute, IndexMode, Indentation, UnitType, DaqType, OptimisationType, AddressExtType,
    IdentificationFieldType, GranularityOdtEntrySize, OverloadIndication, SampleRateType, ChecksumType, EcuAccessType,
    XcpReadAccessType, XcpWriteAccessType
};
