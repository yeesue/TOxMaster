#-------------------------------------------------
#
# A2L_Parser DLL Library
# Generates shared library for XCP_COMM
#
#-------------------------------------------------

QT       += core gui opengl network xml xmlpatterns widgets concurrent printsupport sql script

greaterThan(QT_MAJOR_VERSION, 4): QT += widgets

CONFIG += c++11
CONFIG += dll  # Build as shared library
...
TARGET = A2L_Parser
TEMPLATE = lib
# VERSION = 1.0.0  # Removed to avoid A2L_Parser1.dll naming

# Export definitions
DEFINES += A2L_PARSER_DLL_LIBRARY
DEFINES += QT_DEPRECATED_WARNINGS

# Output directory
win32:DESTDIR = $$PWD/../XCP_COMM/build/driver
win32:DLLDESTDIR = $$PWD/../XCP_COMM/build/driver
...
CONFIG( release, debug|release ) {
    LIBS += -lgomp -lopengl32 -lglu32 -lgdi32
